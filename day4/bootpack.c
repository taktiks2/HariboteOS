...
void HariMain(void) {
    ...
    vram = (char *)0xa0000;  // Assign the address
    xsize = 320;
    ysize = 200;
    ...
    // boxfill8(p, 320, COL8_C6C6C6, 20, 20, 30, 30);
    // boxfill8(p, 320, COL8_FFFFFF, 50, 50, 60, 80);
    // boxfill8(p, 320, COL8_FF0000, 120, 80, 300, 90);

    // for (i = 0; i <= 0xaffff; i++) {
    // p[i] = i & 0x0f;  // p[i] == i[p] == *(p + i)
    // }
